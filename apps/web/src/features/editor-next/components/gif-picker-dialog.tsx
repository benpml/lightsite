...
type EditorNextGifPickerDialogProps = {
  editor: Editor
}
...
export function EditorNextGifPickerDialog({ editor }: EditorNextGifPickerDialogProps) {
  ...
  return (
    ...
    >
      <DialogContent
        showCloseButton
        className="lightsite-next-gif-picker grid h-[min(720px,calc(100vh-2rem))] w-[calc(100vw-2rem)] max-w-[960px] grid-rows-[auto_minmax(0,1fr)_auto] gap-0 overflow-hidden rounded-2xl p-0 sm:max-w-[960px]"
      >
        <DialogHeader className="lightsite-next-gif-picker-header gap-3 px-4 pt-4 pb-3">
          ...
          <label className="relative block">
            ...
            <Input
              autoFocus
              className="lightsite-next-gif-picker-search h-10 pl-9"
        ...
        <div ref={gridContainerRef} className="lightsite-next-gif-picker-results min-h-0 overflow-y-auto px-4 py-4">
          {fetchGifs && lightsiteGiphyClient ? (
            <Grid
              ...
              noLink
              noResultsMessage={
                <div className="lightsite-next-gif-picker-empty flex h-32 items-center justify-center rounded-xl border border-dashed text-sm">
                  No GIFs found
                </div>
              }
              width={gridWidth}
            ...
            <div className="lightsite-next-gif-picker-empty flex h-full min-h-[320px] items-center justify-center rounded-xl border border-dashed px-6 text-center text-sm">
        ...
        <div
          className={cn(
            "lightsite-next-gif-picker-footer flex h-11 items-center px-4",

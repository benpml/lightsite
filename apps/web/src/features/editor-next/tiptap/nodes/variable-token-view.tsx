...
export function VariableTokenView({ deleteNode, editor, node }: NodeViewProps) {
  ...
  return (
    <NodeViewWrapper
      as="span"
      ref={wrapperRef}
      className="lightsite-next-variable-wrapper"
      contentEditable={false}
      data-lightsite-variable-wrapper=""
    >
      <button
        className="lightsite-next-variable-token"
      ...
      {open ? (
        <span
          className="lightsite-next-variable-popover"
          role="dialog"
        ...
        >
          {variable ? (
            <>
              <span className="lightsite-next-variable-popover-header">
                <span className="lightsite-next-variable-popover-title">
                  <IconBraces aria-hidden />
                  Edit variable
                </span>
                <button
                  className="lightsite-next-variable-popover-delete"
                  type="button"
              ...
              <VariableField id={descriptionId} label="Description">
                <Textarea
                  id={descriptionId}
                  className="lightsite-next-variable-control min-h-20 resize-none"
              ...
              <span className="lightsite-next-variable-popover-actions">
                <Button
                  type="button"
                  variant="ghost"
                  size="sm"
            ...
            <>
              <span className="lightsite-next-variable-popover-title">Missing variable</span>
              <span className="lightsite-next-variable-popover-note">

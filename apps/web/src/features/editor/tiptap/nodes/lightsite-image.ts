...
import { SiteImage } from "@lightsite/site-document"
import type { Node as ProseMirrorNode } from "@tiptap/pm/model"

import { readImageFileAsAttrs } from "../image-utils"

export const LightsiteImage = SiteImage.extend<ImageOptions>({
  addNodeView() {
...
function createEmptyImageNodeView({
  ...
  dom.className = "lightsite-editor-image-empty"
  input.accept = "image/*"
  input.ariaHidden = "true"
  input.className = "lightsite-editor-image-empty-input"
  input.hidden = true
  input.tabIndex = -1
  input.type = "file"
  button.className = "lightsite-editor-image-empty-button"
  button.type = "button"
  title.className = "lightsite-editor-image-empty-title"
  title.textContent = "Upload image"
  description.className = "lightsite-editor-image-empty-description"

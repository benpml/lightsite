...
const neutralSolids: TokenRow[] = [
  ...
  token("neutral-450", "#8D8D8D", "Base neutral solid", "Available intermediate neutral step."),
...
const neutralAlphas: TokenRow[] = [
  ...
  alphaToken("neutral-alpha-A400", "14%", "#80808024"),
  alphaToken("neutral-alpha-A300", "12%", "#8080801F"),
...
const shadSemanticTokens: TokenRow[] = [
  ...
  semantic("border-subtle", "neutral-alpha-A500", "neutral-alpha-A300", "Quiet separators and low-emphasis dividers."),

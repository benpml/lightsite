...
function AvatarFallback({
  ...
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        "flex size-full items-center justify-center rounded-[inherit] bg-background text-sm text-foreground group-data-[size=2xs]/avatar:text-[9px] group-data-[size=xs]/avatar:text-[10px] group-data-[size=sm]/avatar:text-[11px] group-data-[size=md]/avatar:text-xs group-data-[size=xl]/avatar:text-base",
        className
      )}
      {...props}
    />
